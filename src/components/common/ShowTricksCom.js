...
const ShowTricksCom = ({ blog }) => {
    ...
    return (
        <div>
            ...
            <Image src={mainImgUrl} width={800} height={500} alt='tire of learn and how to details page' className='h-[300px] md:h-[400px] lg:h-[550px] w-full md:w-4/5 mx-auto my-8 rounded-lg' />
